window.onload = function () {
    ...
    var socket = io.connect('http://' + document.domain + ':' + '100/socket');
    ...
    var resetdiv=document.getElementById('regret');
    var resetbutton = document.createElement('input');
    resetbutton.type = 'button';
    resetbutton.onclick = regret;
    resetbutton.value='regret(cancel last step)';
    resetdiv.appendChild(resetbutton);
